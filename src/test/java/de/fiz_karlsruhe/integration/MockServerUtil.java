...
public class MockServerUtil  implements ExpectationInitializer {
  ...
  private void initGetItem(MockServerClient serverClient) {
    ...
    serverClient.when(request().withMethod("GET").withPath("/item/10\\.0133.*").withQueryStringParameters(new Parameter("format", Arrays.asList("datacite"))))
    .respond(response().withStatusCode(200)
        .withBody("{\n" + 
            "  \"identifier\": \"10.0133/10000386\",\n" + 
            "  \"datestamp\": \"2019-07-12T12:39:37Z\",\n" + 
